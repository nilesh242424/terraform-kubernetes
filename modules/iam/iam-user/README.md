...
###GPG Commands to generate GPG keys

gpg --gen-key

gpg --export "pratap@windli.com" > public.key

base64 -i public.key -o base64_encodede.key

Copy `cat base64_encodede.key` and upload this file to value of "pgp_key" 

###Decrypt key 

echo `$secret` | base64 --decode | gpg --decrypt
